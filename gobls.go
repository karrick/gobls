...
// It is similar to bufio.Scanner, but wraps the ReadLine method of
// bufio.Reader so lines of arbitrary length can be scanned.  Successive calls
// to the Scan method will step through the lines of a file, skipping the
// newline whitespace between lines.
//
...
// bufio.MaxScanTokenSize will not result in an error, but will return the
// long line.
//
