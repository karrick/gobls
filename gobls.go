...
//
// Also like bufio.Scanner, it is not necessary to check for errors by calling the Err method until
// after scanning stops, when the Scan method returns false.
//
// This Scanner ought behave exactly like bufio.Scanner.  All methods ought to have the exact same
// return values while stepping through the given the provided io.Reader.
